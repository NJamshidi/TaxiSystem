...
public class PassengerDataAccess {
    public int addPassenger(Passenger passenger) throws SQLException {
        ...
        if (connection != null) {
            PreparedStatement preparedStatement = connection.prepareStatement("insert into passengers (PassengerUserName,name,family,nationalCode,phoneNumber,age,accountBalance) values (?, ?, ?, ?,? ,?,?)");
            ...
            preparedStatement.setDouble(7, passenger.getAccountBalance());
